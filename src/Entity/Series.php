...
class Series
{
    ...
    /**
     * @Assert\NotBlank(message="please provide a title of a serie ")
    ...
    /**
     * @Assert\Choice(choice={"cancelled","ended","returning"})
     * @ORM\Column(type="string", length=50)
     */
    private $status;

    /**
     * @Assert\Range(min="0",max="10",notInRangeMessage="not message")
